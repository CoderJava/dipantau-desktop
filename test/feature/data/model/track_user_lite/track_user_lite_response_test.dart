...
void main() {
  const tPathJson = 'track_user_lite_response.json';
  final tModel = TrackUserLiteResponse.fromJson(
    json.decode(
      fixture(tPathJson),
    ),
  );
  ...
  test(
    ...
    () async {
      ...
      // act
      final actualModel = TrackUserLiteResponse.fromJson(jsonData);
  ...
  test(
    ...
    () async {
      // arrange
      final model = TrackUserLiteResponse.fromJson(
        json.decode(
          fixture(tPathJson),
        ),
      );
