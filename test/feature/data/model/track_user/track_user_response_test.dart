...
void main() {
  const tPathJson = 'track_user_response.json';
  final tModel = TrackUserResponse.fromJson(
    json.decode(
      fixture(tPathJson),
    ),
  );
  ...
  test(
    ...
    () async {
      ...
      expect(
        tModel.toString(),
        'TrackUserResponse{data: ${tModel.data}}',
      );
    },
  );
  ...
  test(
    ...
    () async {
      ...
      // act
      final actualModel = TrackUserResponse.fromJson(jsonData);
  ...
  test(
    ...
    () async {
      // arrange
      final model = TrackUserResponse.fromJson(
        json.decode(
          fixture(tPathJson),
        ),
      );
