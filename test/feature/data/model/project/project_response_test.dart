...
void main() {
  const tPathJson = 'project_response.json';
  final tModel = ProjectResponseBak.fromJson(
    json.decode(
      fixture(tPathJson),
    ),
  );
  ...
  test(
    ...
    () async {
      ...
      // act
      final actualModel = ProjectResponseBak.fromJson(jsonData);
  ...
  test(
    ...
    () async {
      // arrange
      final model = ProjectResponseBak.fromJson(
        json.decode(
          fixture(tPathJson),
        ),
      );
