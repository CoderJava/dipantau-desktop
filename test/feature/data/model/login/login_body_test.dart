...
void main() {
  const tPathJson = 'login_body.json';
  final tModel = LoginBody.fromJson(
    json.decode(
      fixture(tPathJson),
    ),
  );
  ...
  test(
    ...
    () async {
      ...
      expect(
        tModel.toString(),
        'LoginBody{username: ${tModel.username}, password: ${tModel.password}}',
      );
    },
  );
  ...
  test(
    ...
    () async {
      ...
      // act
      final actualModel = LoginBody.fromJson(jsonData);
  ...
  test(
    ...
    () async {
      // arrange
      final model = LoginBody.fromJson(
        json.decode(
          fixture(tPathJson),
        ),
      );
