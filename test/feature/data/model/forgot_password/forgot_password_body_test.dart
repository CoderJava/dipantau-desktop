...
void main() {
  const tPathJson = 'forgot_password_body.json';
  final tModel = ForgotPasswordBody.fromJson(
    json.decode(
      fixture(tPathJson),
    ),
  );
  ...
  test(
    'pastikan output dari fungsi toString',
      ...
      expect(
        tModel.toString(),
        'ForgotPasswordBody{email: ${tModel.email}}',
      );
    },
  );
  ...
  test(
    'pastikan fungsi fromJson bisa mengembalikan objek class model',
      ...
      // act
      final actualModel = ForgotPasswordBody.fromJson(jsonData);
  ...
  test(
    'pastikan fungsi toJson bisa mengembalikan objek map',
        () async {
      // arrange
      final model = ForgotPasswordBody.fromJson(
        json.decode(
          fixture(tPathJson),
        ),
      );
