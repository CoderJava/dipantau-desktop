...
void main() {
  late BulkCreateTrackImage useCase;
  late MockTrackRepository mockRepository;

  setUp(() {
    mockRepository = MockTrackRepository();
    useCase = BulkCreateTrackImage(repository: mockRepository);
  });
  ...
  final tParams = ParamsBulkCreateTrackImage(body: tBody);
  ...
  test(
    ...
    () async {
      ...
      when(mockRepository.bulkCreateTrackImage(any)).thenAnswer((_) async => tResult);
      ...
      verify(mockRepository.bulkCreateTrackImage(tBody));
  ...
  test(
    ...
    () async {
      ...
      expect(
        tParams.toString(),
        'ParamsBulkCreateTrackImage{body: ${tParams.body}}',
      );
    },
  );
}
